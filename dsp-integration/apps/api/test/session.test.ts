...
describe('contract validator', () => {
  it('fails a response carrying a field the contract does not define', () => {
    ...
    const adv = { advertiserId: 'a', name: 'A', via: [], approvalRequired: true, floorMultiplier: 1, effectiveFloorCpm: 100, bookings: 0, campaigns: { draft: 0, awaiting_approval: 1, approved: 2, rejected: 0 } }
