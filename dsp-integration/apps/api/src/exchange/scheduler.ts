/* The scheduled auction job (API.md "Jobs with no API"): every play window
   is cleared once, ahead of time, when its start is within
   `auctionLeadHours` (Q13). No UI and no endpoint. */
