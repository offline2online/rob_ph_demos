...
/* Loop length of a playlist, for inventory display only (loop share,
   VAC-d reporting). Playback, rotation and targeting evaluation are
   existing Personalisation Hub functionality and are not modelled here. */
