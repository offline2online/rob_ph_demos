...
export const INITIAL_COMPANY_LISTS = {
  ...
  /* keyed by lower-cased advertiser name */
  advertiserSettings: {
    "nestlé": { approvalRequired: false, floorMultiplier: 0.8 },
    "swisse": { approvalRequired: true, floorMultiplier: 1 },
    "l'oréal": { approvalRequired: true, floorMultiplier: 1.2 },
  },
  /* per variable: "all" connected DSPs, or a list of partner ids */
  variableAccess: {
    "store.suburb": [], "store.postcode": [], "store.country": [], "store.languages": [],
    "store.reason_for_visit": ["p_google"],
    "visitor.purchase_intent": ["p_google"],
  },
};

export const INITIAL_PARTNERS = [
  partner({ id: "p_google", provider: "google_dsp", name: "Google DSP", status: "connected", mode: "live",
    creds: { partnerId: "884512", saEmail: "ph-retail-media@ph-demo.iam.gserviceaccount.com", saKey: "•".repeat(24) },
  ...
  partner({ id: "p_amazon", provider: "amazon_dsp", name: "Amazon Ads DSP", status: "error", mode: "test",
    creds: { region: "Europe (EU)", clientId: "amzn1.application-oa2-client.7f3c", clientSecret: "•".repeat(16), refreshToken: "•".repeat(16), profileId: "3390127745", entityId: "ENTITY8Q1R5T" },
...
/* Displays registered on the platform (Displays & Devices), by display type.
   A display type cannot be deleted while any display is assigned to it. */
export const INITIAL_DISPLAYS = [
  { id: "d_1001", name: "Entrance Screen", store: "Sydney CBD", typeId: "landscape" },
  { id: "d_1002", name: "Checkout Screen", store: "Sydney CBD", typeId: "landscape" },
  { id: "d_1003", name: "Aisle 3 Portrait", store: "Parramatta", typeId: "portrait" },
  { id: "d_1004", name: "Menu Board", store: "Sydney CBD", typeId: "menu_board" },
  { id: "d_1005", name: "Menu Board", store: "Chatswood", typeId: "menu_board" },
  { id: "d_1006", name: "Menu Board", store: "Bondi Junction", typeId: "menu_board" },
];
